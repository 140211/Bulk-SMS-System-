...
<div class="container">
  <div class="info">
    <table align="center" width="60%" border="1">
        <tr> 
           <th><strong><font align="center" size = "5">Compaign id</font></strong></th>
  ...
  //$sql = "SELECT * FROM contacts, compaign where contacts.userID = compaign.userID and compaign.Title LIKE *'".test."'*" ;
    $sql = "SELECT Title,txt,cmpinID FROM compaign WHERE Title = '" . $message. "' " ;
  ...
  // for message
    ...
    ?>
        <tr> 
          ...
          <td><font color="#000000" size = "4.5"><?php echo ($row['cmpinID']); ?></font></td>
          <td><font color="#000000" size = "4.5"><?php echo ($row['Title']); ?></font></td>
          
           <td><form action='q.php' method='POST'><input type='submit' name='insert' value='SHOW DETAILS'" . "></td>
        </tr>
  	<?php
    }
    ?>
