...
if (isset($_POST['signup'])) {
	...
	// }
	if (!$error) {
		if(mysqli_query($con, "INSERT INTO users(id, name, email, password) VALUES ('','" . $name . "', '" . $email . "', '" . md5($password) . "')")) {
			...
			<form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="signupform">
				<fieldset>
					...
					<div class="form-group">
						...
						<input type="mobile number" name="mobile" placeholder="Mobile Number" required class="form-control" />
